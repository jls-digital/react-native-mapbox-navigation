 ...
 */
export const KNOWN_ERROR_CODES = ['ROUTE_CALCULATION_FAILED', 'GPS_UNAVAILABLE', 'GPS_PERMISSION_DENIED', 'NETWORK_ERROR', 'INVALID_COORDINATES', 'SDK_INIT_FAILED'];
const KNOWN_ERROR_CODE_SET = new Set(KNOWN_ERROR_CODES);
 ...
 */
export const FALLBACK_ERROR_CODE = 'SDK_INIT_FAILED';
 ...
 */
export function resolveErrorEvent(code, message) {
  ...
  if (__DEV__) {
    console.warn(`MapboxNavigation: received unrecognized native error code "${code}"; ` + `reporting it as "${FALLBACK_ERROR_CODE}". ` + 'The raw code is preserved in the error message.');
  }
...
//# sourceMappingURL=resolveErrorEvent.js.map