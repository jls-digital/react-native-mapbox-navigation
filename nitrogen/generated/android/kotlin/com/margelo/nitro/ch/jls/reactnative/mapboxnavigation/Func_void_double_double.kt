...
/**
 * Represents the JavaScript callback `(latitude: number, longitude: number) => void`.
...
fun interface Func_void_double_double: (Double, Double) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(latitude: Double, longitude: Double): Unit
}
...
class Func_void_double_double_cxx: Func_void_double_double {
  ...
  @Keep
  override fun invoke(latitude: Double, longitude: Double): Unit
    = invoke_cxx(latitude,longitude)

  @FastNative
  private external fun invoke_cxx(latitude: Double, longitude: Double): Unit
}
...
class Func_void_double_double_java(private val function: (Double, Double) -> Unit): Func_void_double_double {
  ...
  @Keep
  override fun invoke(latitude: Double, longitude: Double): Unit {
    return this.function(latitude, longitude)
  }
}
