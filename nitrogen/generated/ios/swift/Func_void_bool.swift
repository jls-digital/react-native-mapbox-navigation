...
/**
 * Wraps a Swift `(_ isMuted: Bool) -> Void` as a class.
...
public final class Func_void_bool {
  ...
  private let closure: (_ isMuted: Bool) -> Void

  public init(_ closure: @escaping (_ isMuted: Bool) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(isMuted: Bool) -> Void {
    self.closure(isMuted)
  }
